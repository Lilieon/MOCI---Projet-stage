...
\includegraphics[width=\textwidth]{"Remplir la fiche de renseignements"}

\includegraphics[width=\textwidth]{"Acceder a son compte et suivre son stage"}

\includegraphics[width=\textwidth]{"Signer la convention et la consulter"}

\includegraphics[width=\textwidth]{"Editer son profil"}

\includegraphics[width=\textwidth]{"Deposer et consulter son rapport"}

\includegraphics[width=\textwidth]{"Consulter les avis de l'entreprise"}

\includegraphics[width=\textwidth]{"Telecharger un template du rapport"}

\subsection{Pour la scolarité}


\includegraphics[width=\textwidth]{"Acceder a la liste des entreprises"}

\includegraphics[width=\textwidth]{"Elaborer le planning des soutenances"}

\includegraphics[width=\textwidth]{"Gerer les passages et redoublements"}

\includegraphics[width=\textwidth]{"Recuperer les rapports"}

\includegraphics[width=\textwidth]{"Suivre les comptes etudiants"}


\subsection{Pour l'entreprise}

\includegraphics[width=\textwidth]{"Acceder au rapport"}

\includegraphics[width=\textwidth]{"Accepter visite"}

\includegraphics[width=\textwidth]{"Donner son avis sur le stage etudiant"}

\includegraphics[width=\textwidth]{"Remplir le questionnaire d'evaluation"}

\includegraphics[width=\textwidth]{"Signer - remplir la convention"}

\includegraphics[width=\textwidth]{"Suivre son stagiaire"}

\includegraphics[width=\textwidth]{"Valider la diffusion du rapport"}

\subsection{Pour l'administration}

\includegraphics[width=\textwidth]{"Acceder a la fiche de renseignements et autres documents"}

\includegraphics[width=\textwidth]{"Gerer des statistiques"}

\includegraphics[width=\textwidth]{"Gerer attribution du tuteur academique"}

\includegraphics[width=\textwidth]{"Valider les stages"}


\subsection{Pour l'enseignant}

\includegraphics[width=\textwidth]{"Acceder a la fiche de renseignements et autres documents2"}

\includegraphics[width=\textwidth]{"Acceder aux informations"}

\includegraphics[width=\textwidth]{"Demander pour faire une visite"}

\includegraphics[width=\textwidth]{"Donner une note - un avis"}
