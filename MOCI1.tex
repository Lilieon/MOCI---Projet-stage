...
\fbox{\centerline{\includegraphics[height=0.9\textheight]{"Stages"}}}
...
&&& incr\`emental \\
nom & Nom de l'\`etudiant & Alphanum\`erique & \\
pr\`enom & Pr\`enom de l'\`etudiant & Alphanum\`erique & \\
mdp & Mot de passe & Alphanum\`erique & \\
ann\`ee & Ann\`ee universitaire & Date & \\
promo & 2A ou 3A & Alphanum\`erique & \\
mail & Adresse email & Alphanum\`erique & \\
date\_naissance & Date de naissance & Date & \\
sexe & & Alphanum\`erique & \\
approfondissement & Approfondissement de l'\`etudiant & Alphanum\`erique & \\
...
=======
>>>>>>> 89578601a3c2cea1a7bb69d9c5fd30ec9b664b4b
\newpage
\begin{flushleft}
\textbf{Tuteur}
\end{flushleft}
...
\end{document}
Contact GitHub API Training Shop Blog About
>>>>>>> 63f56567535d2306a1d05a22dfe62fdbfb27ce98
